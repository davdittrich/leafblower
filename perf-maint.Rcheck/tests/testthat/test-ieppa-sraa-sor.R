test_that("ieppa+sraa with SOR re-enabled: max_err within 2x of plain", {
  ...
  r_plain <- suppressWarnings(harvest(ss, tgt, method = "ieppa",
                                      max_iterations = 200L,
                                      accelerate = FALSE))
  r_sraa  <- suppressWarnings(harvest(ss, tgt, method = "ieppa",
                                      max_iterations = 200L,
                                      accelerate = TRUE))
