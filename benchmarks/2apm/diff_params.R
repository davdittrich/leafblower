...
# ---- Build TOON rows ----
# 39 positional SEXP args to C_rk_calibrate (r_bridge.cpp:177-201), in call order.
...
# All 39 positional SEXPs enumerated. epsilon removed (not a SEXP; rk_params_t ABI field only).
...
short_circuit_reason <- paste0(
  "No true mismatches on any of the 39 positional SEXP args. ",
