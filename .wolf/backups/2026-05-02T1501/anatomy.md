...
> Auto-maintained by OpenWolf. Last scanned: 2026-05-02T14:59:26.206Z
...
- `NAMESPACE` (~71 tok)
- `NEWS.md` — leafblower (development version) (~1419 tok)
...
- `post-checkout` — --- BEGIN BEADS INTEGRATION v1.0.3 --- (~795 tok)
- `post-commit` — graphify-hook-start (~625 tok)
- `post-merge` — --- BEGIN BEADS INTEGRATION v1.0.3 --- (~210 tok)
- `pre-commit` — --- BEGIN BEADS INTEGRATION v1.0.3 --- (~210 tok)
- `pre-push` — --- BEGIN BEADS INTEGRATION v1.0.3 --- (~208 tok)
- `prepare-commit-msg` — --- BEGIN BEADS INTEGRATION v1.0.3 --- (~218 tok)
...
## .claude/worktrees/agent-a060b207d4ea59804/
...
- `LICENSE` — Project license (~16 tok)
- `NAMESPACE` (~71 tok)
- `NEWS.md` — leafblower (development version) (~1357 tok)
- `patch_raking.py` — Declares CalibState (~4573 tok)
- `patch_wolfe.py` — patch_wolfe, patch_wolfe_line_search (~903 tok)
- `REVIEW_FINDINGS.md` — Code Review: harvest.R & calib_dispatch.hpp (~775 tok)
- `security-review-2026-04-27-ieppa.json` (~3036 tok)
...
## .claude/worktrees/agent-a060b207d4ea59804/.beads/
...
## .claude/worktrees/agent-a060b207d4ea59804/.beads/hooks/
...
## .claude/worktrees/agent-a060b207d4ea59804/.beads/plans/

- `active-plan.md` — Active Plan (~643 tok)

## .claude/worktrees/agent-a060b207d4ea59804/.claude/

- `settings.json` (~336 tok)
- `settings.local.json` (~1169 tok)

## .claude/worktrees/agent-a060b207d4ea59804/.claude/rules/

- `openwolf.md` (~313 tok)

## .claude/worktrees/agent-a060b207d4ea59804/.claude/skills/
...
## .claude/worktrees/agent-a060b207d4ea59804/.code-review-graph/

- `.gitignore` — Git ignore rules (~38 tok)

## .claude/worktrees/agent-a060b207d4ea59804/.gemini-bridge/

- `feedback.log` (~756 tok)

## .claude/worktrees/agent-a060b207d4ea59804/.gemini/

- `settings.json` (~137 tok)

## .claude/worktrees/agent-a060b207d4ea59804/.tldr/

- `languages.json` (~35 tok)

## .claude/worktrees/agent-a060b207d4ea59804/.tldr/cache/

- `call_graph.json` (~1484 tok)

## .claude/worktrees/agent-a060b207d4ea59804/benchmarks/
...
- `basin_overlap_kill_switch.R` — WI-0b: basin-overlap kill-switch for Epic-C IEPPA warm-start. (~996 tok)
...
- `jacobi_sweep_study.R` — BENCHMARK RESULTS SUMMARY (rx1): (~943 tok)
- `jacobi_sweep_study.rds` (~177 tok)
- `k_warm_sweep.R` — WI-1 empirical K_warm=8 validation. (~584 tok)
...
- `tsvd_kk1204_K20.R` — WL-5: kk1204 K=20 severe-skew PARTIAL gate (gap < 1e-3 desirable; not a halt) (~432 tok)
- `tsvd_pinv_T2.R` — WL-2: T2 stepstone pinv-only measurement gate (~478 tok)
- `tsvd_T7_well_conditioned.R` — WL-4: T7 K=4 well-conditioned over-projection regression test (~658 tok)

## .claude/worktrees/agent-a060b207d4ea59804/benchmarks/results/

- `basin_overlap_killswitch.csv` (~50 tok)
- `k_warm_sweep.csv` (~49 tok)
- `lm_pivot_sweep.csv` (~103 tok)
- `tsvd_kk1204_K20.csv` (~25 tok)
- `tsvd_pinv_T2.csv` (~23 tok)
- `tsvd_T7_K4.csv` (~27 tok)

## .claude/worktrees/agent-a060b207d4ea59804/data-raw/
...
## .claude/worktrees/agent-a060b207d4ea59804/docs/
...
## .claude/worktrees/agent-a060b207d4ea59804/docs/iEPPA/arxiv.2011.14312/

- `iEPPA-LP-R2-arXiv.tex` — Declares of (~50652 tok)

## .claude/worktrees/agent-a060b207d4ea59804/docs/iEPPA/arxiv.2011.14312/references/

- `Ref_iEPPA.bib` — Declares measures (~7454 tok)

## .claude/worktrees/agent-a060b207d4ea59804/docs/iEPPA/code/2Dtomography/

- `master.m` — Declares of (~728 tok)

## .claude/worktrees/agent-a060b207d4ea59804/docs/iEPPA/code/2Dtomography/main/

- `EPPA.m` (~2376 tok)
- `Gprocedure.m` — Declares goes (~502 tok)

## .claude/worktrees/agent-a060b207d4ea59804/docs/iEPPA/code/2Dtomography/tools/
...
## .claude/worktrees/agent-a060b207d4ea59804/docs/iEPPA/code/ExpSynthesisData/

- `run_cot_2d.m` (~1100 tok)
- `run_cot_3d.m` (~892 tok)

## .claude/worktrees/agent-a060b207d4ea59804/docs/iEPPA/code/ExpSynthesisData/solvers/
...
## .claude/worktrees/agent-a060b207d4ea59804/docs/investigations/
...
- `2026-05-01-newton-kl-homotopy-result.md` — Newton-KL Target Homotopy — Result (~1475 tok)
- `2026-05-01-newton-kl-lm-result.md` — Newton-KL LM-Damping Convergence Fix — Result (~1203 tok)
- `2026-05-02-newton-kl-ieppa-warmstart-result.md` — Newton-KL IEPPA Warm-Start — Result (~2007 tok)

## .claude/worktrees/agent-a060b207d4ea59804/docs/superpowers/plans/
...
- `2026-05-01-chebyshev-nu-correction.md` — Chebyshev IPM ν Dual Correction — Implementation Plan (~10214 tok)
...
- `2026-05-01-jacobi-log-sweep.md` — iEPPA Log-Path Jacobi Sweep — Implementation Plan (~6572 tok)
- `2026-05-01-newton-kl-calibration.md` — Newton-KL Calibration Solver — Implementation Plan (~7111 tok)
- `2026-05-01-newton-kl-homotopy-plan.md` — Newton-KL Target Homotopy — Plan (rev 2) (~4194 tok)
- `2026-05-01-newton-kl-ieppa-warmstart-plan.md` — Newton-KL IEPPA Warm-Start — Plan (rev 3) (~14525 tok)
- `2026-05-01-newton-kl-lm-plan.md` — Newton-KL LM-Damping Convergence Fix — Plan (rev 2) (~2968 tok)
- `2026-05-01-validation-dedup.md` — Validation Target-Sum Dedup Implementation Plan (~1023 tok)
- `2026-05-02-newton-kl-rank-projection-plan.md` — Newton-KL Rank-Deficient Direction Projection — Implementation Plan (~6244 tok)
- `2026-05-02-newton-kl-tsvd-cg-plan.md` — Epic-Dβ: Truncated-SVD + Steihaug-CG Trust-Region Newton (LAPACK-backed) (~7893 tok)

## .claude/worktrees/agent-a060b207d4ea59804/docs/superpowers/specs/
...
- `2026-05-01-jacobi-log-sweep-design.md` — iEPPA Log-Path Jacobi Sweep — Design Spec (~1210 tok)
- `2026-05-01-newton-kl-calibration-design.md` — Newton-KL Calibration Solver — Design Spec (rev 2) (~3826 tok)

## .claude/worktrees/agent-a060b207d4ea59804/graphify-out/

- `.graphify_python` (~4 tok)
- `.graphify_root` (~19 tok)
- `cost.json` (~59 tok)
- `GRAPH_REPORT.md` — Graph Report - agent-a060b207d4ea59804  (2026-05-02) (~5962 tok)
- `graph.html` — graphify - graphify-out/graph.html (~100362 tok)
- `graph.json` (~126953 tok)
- `manifest.json` (~4366 tok)

## .claude/worktrees/agent-a060b207d4ea59804/graphify-out/cache/ast/

- `007f9032d1a241eb1dc12e4a8f5c9ba4fedd3e3759277b8b40f62a05d324a785.json` (~25758 tok)
- `04a34252d1d3df2f4832a4d92fa4564a3247c8013fed67392480ace8248c4a0e.json` (~120 tok)
- `096d6838512a750331a6c08d75ea91e6c6e2b8cb976b691e35c279591fe18aeb.json` (~274 tok)
- `0efa79ccc5705b802e8ef7b999aa8f754276e7239ae323ed777857ca891bfaca.json` (~7192 tok)
- `b47adcf093a583baa4a80ae720c13fc8fe106e82bdba18d9ee3a8e6f2c2b7f4a.json` (~112 tok)
- `b56d9563a6ee3bf5661f53d14ad65e6333d888673b5efa615635182c3247285c.json` (~2760 tok)
- `b968916ca9b60e743bcd3d9d2945eed082c0d006b05a46f8fe1c35534925b885.json` (~261 tok)
- `c013047638b2c45a7b0435251727f71e542419f88251d93232ecaaa1da87af0d.json` (~118 tok)
- `c27bd827b470e91a26a28c0e3c972d91b93e84899ced6ac9b9962310a8adfe15.json` (~1178 tok)
- `c2ec4fa1ee0153bb604bbbf81491dd4955cfcae51cbe3f655a711d027b1ae400.json` (~397 tok)
- `c839d09100c431789d977c1bc63ea881876aaa3a81e9e50c4fcfb5e8376e2bc0.json` (~14990 tok)
- `c9d3bd7eccb5656291ab35921f3cc0b9214060cce78c9f47e1a8d166326f726b.json` (~260 tok)
- `cbb0afcebc29146f1481bab288a7e169811e5641234c1c1550b41f84015968d0.json` (~219 tok)
- `d496bffb6abae7ec9418db31601b4f3aa020500c2a95382b29bc52aee0c04506.json` (~614 tok)
- `d4df00bc5075cfeb7cce87d310f50478049893fd17c7cdc117b382ecc2d15afb.json` (~1404 tok)
- `d630a3d533d5b7cdddd5929053e877d13560dd925e18cc54128143df55f8ec0b.json` (~569 tok)
- `d851e60e387c9b1f2c291336a00e11ac2cece5465a035ffc7f3d6dda0a4a7c7a.json` (~469 tok)
- `d85bd456edd5f960733af956720cb05fb29ca1e421c1cece93738645a34e8069.json` (~5556 tok)
- `da07fd57403d1b484eb706ac8e36bc3d602b028ffede24adff7bf42daf62e8c6.json` (~184 tok)
- `da2ca2497810415b589f58a553db1f3f1f96705eebe83e71305c5b2881ddb526.json` (~31126 tok)
- `ed4eff8e622cd97a68367d48ceb6858fcb430e7164b1e9c218ac75464ae5855a.json` (~451 tok)
- `efb99caccefa5ef0b2a014ca2d31b1903f343afbc270c6fa19f82000512ad889.json` (~106 tok)
- `f489bf78ded0fc1688d0a045a129c9f53a646e6ac37b73545fadac8103cd5d3a.json` (~3021 tok)
- `f7659214aa6d160ec232e9dad15bc4ad90a8d4874d868825d7a4407aae2ce154.json` (~461 tok)
- `f82c016626a1b588ee0d332b0350dda2b927b504eae3c591499d57ae0dcc1126.json` (~772 tok)
- `fb7fa61519bc1bded5aeefe5aa68612bee569aa6c5b2cc89d0de35a11f11317d.json` (~374 tok)
- `fcc16fa67cd6e64eeafe3f140285ebe5eb2e8261764c93a1b88061f5737c33d4.json` (~4789 tok)
- `ff6648c827e169724ed6fb80f0b49623eee01acd014f1e22ef87e670159f09c3.json` (~3477 tok)

## .claude/worktrees/agent-a060b207d4ea59804/leafblower.Rcheck/

- `00check.log` — Declares calls (~1084 tok)
- `00install.out` (~742 tok)

## .claude/worktrees/agent-a060b207d4ea59804/leafblower.Rcheck/00_pkg_src/leafblower/
...
## .claude/worktrees/agent-a060b207d4ea59804/leafblower.Rcheck/00_pkg_src/leafblower/.gemini-bridge/

- `feedback.log` (~80 tok)

## .claude/worktrees/agent-a060b207d4ea59804/leafblower.Rcheck/00_pkg_src/leafblower/.pytest_cache/

- `CACHEDIR.TAG` (~51 tok)
- `README.md` — Project documentation (~76 tok)

## .claude/worktrees/agent-a060b207d4ea59804/leafblower.Rcheck/00_pkg_src/leafblower/.pytest_cache/v/cache/

- `lastfailed` (~1 tok)
- `nodeids` (~57 tok)

## .claude/worktrees/agent-a060b207d4ea59804/leafblower.Rcheck/00_pkg_src/leafblower/.tldr/

- `languages.json` (~35 tok)

## .claude/worktrees/agent-a060b207d4ea59804/leafblower.Rcheck/00_pkg_src/leafblower/.tldr/cache/

- `call_graph.json` (~708 tok)

## .claude/worktrees/agent-a060b207d4ea59804/leafblower.Rcheck/00_pkg_src/leafblower/R/
...
## .claude/worktrees/agent-a060b207d4ea59804/leafblower.Rcheck/00_pkg_src/leafblower/man/
...
## .claude/worktrees/agent-a060b207d4ea59804/leafblower.Rcheck/00_pkg_src/leafblower/src/
