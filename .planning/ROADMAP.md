...
- [ ] 05-01-PLAN.md — Tracer: git-hygiene strays removed, .Rbuildignore extended, local `R CMD check --as-cran` clean, cran-comments.md (SC1, SC2, D-01/D-04/D-05/D-06)
- [ ] 05-02-PLAN.md — Version-sync test guarding DESCRIPTION vs. pyproject.toml drift (SC5, D-03)
- [ ] 05-03-PLAN.md — R CI: .github/workflows/r-check.yml operationalizing the proven local check + hygiene guard (SC1, SC2, D-02)
...
| 5. CRAN + PyPI Release | 0/5 | Not started | - |
